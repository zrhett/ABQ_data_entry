...
class DataRecordForm(tk.Frame):
    ...
    def __init__(self, parent, fields, *args, **kwargs):
        ...
        self.inputs['Humidity'] = w.LabelInput(environmentinfo, 'Humidity (g/m³)', field_spec=fields['Humidity'])
        ...
        self.inputs['Temperature'] = w.LabelInput(environmentinfo, 'Temperature (°C)', field_spec=fields['Temperature'])
