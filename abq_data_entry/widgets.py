...
class ValidateMixin:
    ...
    def __init__(self, *args, error_var=None, **kwargs):
        ...
        self.config(validate='all', validatecommand=(vcmd, '%P', '%s', '%S', '%V', '%i', '%d'),
    ...
    def _validate(self, proposed, current, char, event, index, action):
        ...
        if event == 'focusout':
            ...
            valid = self._key_validate(proposed=proposed, current=current, char=char, event=event,
    ...
    def _invalid(self, proposed, current, char, event, index, action):
        if event == 'focusout':
            ...
            self._key_invalid(proposed=proposed, current=current, char=char, event=event,
                              index=index, action=action)
...
class ValidatedSpinbox(ValidateMixin, tk.Spinbox):
